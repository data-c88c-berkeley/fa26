...
description: How to pair program on Data C88C assignments.
nav_exclude: true
---
...
In pair programming, partners are working together _at the same time_.
...
For sharing code, use a collaborative editing session such as VS Code's Live Share extension.
...
See the [syllabus on learning cooperatively]({% link syllabus.md %}#learning-cooperatively) for more information.

### Finding a partner

We recommend finding a partner in your discussion or refer to the pinned partner finding post on Edstem.
